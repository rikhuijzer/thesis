\section{BERT}
\label{sec:bert}
At the start of October 2018 Google published their NLP system called BERT~\citep{devlin2018}.
During publication it was able to score state-of-the-art (SOTA) results for eleven NLP tasks.
